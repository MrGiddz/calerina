...
class MenuService
{
    ...
    public function data(): array
    {
        ...
        $menu = [
            ...
            'ai_voice_isolator' => [
                ...
                'extension'        => true,
                'active_condition' => null,
                'show_condition'   => setting('ai_voice_isolator', '1') == '1'
                    && file_exists(base_path('resources/views/default/panel/user/openai/components/generator_voice_isolator.blade.php')),
            ],
            'ai_voiceover_clone' => [
                'parent_key'       => null,
            ...
            'introductions' => [
                ...
                'show_condition' => Route::has('dashboard.introductions.index'),
                'is_admin'       => true,
            ],
            ...
            'invoice' => [
                'parent_key'       => 'settings',
                'key'              => 'invoice',
                'route'            => 'dashboard.admin.settings.invoice',
                'label'            => 'Invoice',
                'icon'             => 'tabler-device-laptop',
                'svg'              => null,
                'order'            => 77,
            ...
            'affiliate_setting' => [
                ...
                'route'            => 'dashboard.admin.settings.affiliate',
                'label'            => 'Affiliate',
                'icon'             => 'tabler-device-laptop',
                'svg'              => null,
                'order'            => 78,
            ...
            'smtp' => [
                'parent_key'       => 'settings',
                'key'              => 'smtp',
                'route'            => 'dashboard.admin.settings.smtp',
                'label'            => 'SMTP',
                'icon'             => 'tabler-device-laptop',
                'svg'              => null,
                'order'            => 80,
            ...
            'gdpr' => [
                'parent_key'       => 'settings',
                'key'              => 'gdpr',
                'route'            => 'dashboard.admin.settings.gdpr',
                'label'            => 'GDPR',
                'icon'             => 'tabler-device-laptop',
                'svg'              => null,
                'order'            => 81,
            ...
            'languages' => [
                'parent_key'       => 'settings',
                'key'              => 'languages',
                'route'            => 'elseyyid.translations.home',
                'label'            => 'Languages',
                'icon'             => 'tabler-device-laptop',
                'svg'              => null,
                'order'            => 83,
            ...
            'storage' => [
                'parent_key'       => 'settings',
                'key'              => 'storage',
                'route'            => 'dashboard.admin.settings.storage',
                'label'            => 'Storage',
                'icon'             => 'tabler-device-laptop',
                'svg'              => null,
                'order'            => 84,
    ...
    public function mergeExtensionMenu($menu)
    {
        ...
        if (class_exists('App\Models\Automation\Automation')) {
            $is_automation_active = \App\Models\Automation\Automation::getAutomationActive();
        }
    ...
    public static function planAiToolsMenu(): array
    {
        $keys = [
            ...
            'ai_social_media_extension', 'ai_detector_extension', 'ai_plagiarism_extension', 'ai_article_wizard',
        ];
