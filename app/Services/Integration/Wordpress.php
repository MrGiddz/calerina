...
class Wordpress
{
    const LOGIN_URL = "/wp-json/api/v1/token";
    const POST_URL = "/wp-json/wp/v2/posts";
    const CATEGORY_URL = "/wp-json/wp/v2/categories";
    const TAG_URL = "/wp-json/wp/v2/tags";
    const IMAGE_URL = "/wp-json/wp/v2/media";
