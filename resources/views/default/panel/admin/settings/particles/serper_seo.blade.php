    ...
    >
        ...
        <div class="mb-1 grid grid-cols-2 gap-4 md:grid-cols-3">
            <x-forms.input
                ...
                :checked="setting('serper_seo_aw_keyword', 0) == 1 ? true : false"
                type="checkbox"
            ...
            <x-forms.input
                ...
                class="checked-item"
                id="serper_seo_aw_sq"
                :checked="setting('serper_seo_aw_sq', 0) == 1 ? true : false"
                type="checkbox"
            ...
            <x-forms.input
                ...
                class="checked-item"
                id="seo_ai_tool"
                :checked="setting('seo_ai_tool', 1) == 1 ? true : false"
                type="checkbox"
                name="seo_ai_tool"
                label="{{ __('SEO Tool') }}"
                custom
            ...
            <x-forms.input
                ...
                :checked="setting('serper_seo_tool_improve', 0) == 1 ? true : false"
                type="checkbox"
    ...
    >
        ...
        <div class="mb-1 grid grid-cols-2 gap-4 md:grid-cols-3">
            <x-forms.input
                ...
                :checked="setting('serper_seo_blog_title_desc', 0 == 1 ? true : false)"
                type="checkbox"
            ...
            <x-forms.input
                ...
                :checked="setting('serper_seo_site_meta', 0) == 1 ? true : false"
                type="checkbox"
