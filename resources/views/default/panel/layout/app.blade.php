@php
    ...
    $has_sidebar = in_array(Route::currentRouteName(), $sidebarEnabledPages) || (isset($has_sidebar) && $has_sidebar);
...
@php
    $setting = $setting ?? (object)[
        ...
        'dashboard_code_before_head' => null,
        'dashboard_code_before_body' => null,
    ];
@endphp
...
<body @class([
    ...
    @auth
        <script>
            const focusModeEnabled = localStorage.getItem("lqdFocusModeEnabled");
    ...
    {{--    @stack('live-script') --}}
    @includeWhen(\App\Helpers\Classes\Helper::showIntercomForVipMembership(),'default.panel.layout.includes.vip-intercom')
</body>
