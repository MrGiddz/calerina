    ...
    <div class="py-10">
        <div class="mx-auto w-full md:w-8/12 xl:w-5/12">
            ...
            <p class="mb-9 font-medium">
                @lang('Simply select the source and Ai Dingle will do the rest to train your GPT in seconds.')
            </p>
            ...
            <div x-data="{
                ...
                <div>
                    @include('panel.user.chat.chatbot.particles.web-site-tab')
                    @include('panel.user.chat.chatbot.particles.pdf-tab')
                    @include('panel.user.chat.chatbot.particles.text-tab')
                    @include('panel.user.chat.chatbot.particles.qa-tab')
                </div>
            </div>
        </div>
